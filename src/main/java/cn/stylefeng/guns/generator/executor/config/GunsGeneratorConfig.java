...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        globalConfig.setOutputDir("f:\\guns");//写自己项目的绝对路径,注意具体到java目录
        globalConfig.setFileOverride(true);
        globalConfig.setEnableCache(false);
        globalConfig.setBaseResultMap(true);
        globalConfig.setBaseColumnList(true);
        globalConfig.setOpen(false);
        globalConfig.setAuthor("tyj");
    }
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.1.10:3306/milestone?characterEncoding=utf8");
    }

    protected void strategyConfig() {
        strategyConfig.setTablePrefix(new String[]{"mt_"});// 此处可以修改为您的表前缀
        strategyConfig.setNaming(NamingStrategy.underline_to_camel);
    }

    protected void packageConfig() {
        packageConfig.setParent(null);
        packageConfig.setEntity("com.yhxd.mt.model");
        packageConfig.setMapper("com.yhxd.mt.dao");
        packageConfig.setXml("com.yhxd.mt.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.yhxd.mt");
        contextConfig.setCoreBasePackage("com.yhxd.mt.core");
